...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between m-5 mb-2">
            ...
            <a href="#" data-route="{{ route('user.resetPassword') }}" class="btn btn-primary add-new-role" data-bs-target="#addRoleModal"
                data-bs-toggle="modal" class="dropdown-item add-new-role"><i class="ti ti-key me-1"></i> Reset
                Password</a>
        </div>
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control phone-mask" name="last_name" value="{{ $user->last_name }}" disabled />
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" name="contact_no" value="{{ $user->contact_no }}" autofocus disabled>
          </div>
