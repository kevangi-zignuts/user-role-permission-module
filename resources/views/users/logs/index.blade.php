            ...
            <div class="search-container ">
                <form action="{{ route('activityLogs.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search Activity Log..." name="search"
                            value="">
            ...
            <form action="{{ route('activityLogs.index') }}" method="GET">
                <div class="input-group ">
                    <select name="filter" class="form-select" id="inputGroupSelect04"
                        ...
                        <option value="0" {{ $filter == '0' ? 'selected' : '' }}>InActivated Activity Logs</option>
                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input data-id="{{ $log->id }}" class="form-check-input toggle-class"
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "GET",
                                dataType: "json",
                                url: "/user/activityLogs/status/" + id,
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "GET",
                                dataType: "json",
                                url: "/user/activityLogs/delete/" + id,
                                success: function(data) {
                                    if (data.success) {
                                        row.remove();
                                        Swal.fire({
