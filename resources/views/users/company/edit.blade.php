        ...
        <div class="card-body">
          ...
          <form action="{{ route('company.store') }}" method="post"  id="formAuthentication" class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="company_name" autofocus required>
              @error('company_name')
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="owner_name" autofocus required>
              @error('owner_name')
                <div class="pt-2 text-danger">{{ $message }}</div>
              @enderror
            </div>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="industry" autofocus required>
              @error('industry')
                <div class="pt-2 text-danger">{{ $message }}</div>
              @enderror
            </div>
